...
public class WebCrawlerJ{
	...
	public static void main(String[] args) throws IOException{
		...
		String front = "http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&p=1&u=%2Fnetahtml%2FPTO%2Fsearch-bool.html&r=";
		String back = "&f=G&l=50&co1=AND&d=PTXT&s1=%28mounting.CLTX.+or+mounting.DCTX.%29&s2=%28photovoltaic.CLTX.+or+photovoltaic.DCTX.%29&OS=ACLM/mounting+AND+ACLM/photovoltaic";
		...
		String pats_header = "pat_id, title, USPA#, date, assignee, city, state\n";
		...
		for(int i = 0; i < n; i++){
			...
			try{
				...
				Element table2 = doc.getElementsContainingOwnText("Filed:").get(0).parent().parent().parent();
